...
export default function ProductType({
    ...
    return (
        <div className="mt-[1.25rem] flex h-[9.4375rem] w-[12.875rem] flex-col justify-between rounded-[0.625rem] bg-white pb-[1.44rem] pl-[0.87rem] pt-[0.5rem] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
